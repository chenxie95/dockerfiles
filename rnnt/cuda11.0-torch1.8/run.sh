docker build -t rnnt-cuda11.0-torch1.8 .
docker tag rnnt-cuda11.0-torch1.8:latest chenxie95/rnnt-cuda11.0:torch1.8
docker push chenxie95/rnnt-cuda11.0:torch1.8
